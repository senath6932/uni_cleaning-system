    ...
    return (
      <main className="flex min-h-screen items-center justify-center bg-slate-950 px-6 text-slate-100">
        <div className="max-w-xl rounded-3xl border border-red-500/30 bg-red-500/10 p-8">
          <h1 className="text-3xl font-semibold text-white">Administration Officer access only</h1>
          <p className="mt-3 text-sm leading-7 text-slate-300">
            This dashboard is restricted to Administration Officers.
          </p>
        </div>
      </main>
    );
        ...
        <header className="rounded-3xl border border-white/10 bg-white/5 p-6">
          <div className="flex items-center justify-between gap-4">
            <div>
              ...
              <h1 className="mt-2 text-3xl font-semibold text-white">Report review</h1>
